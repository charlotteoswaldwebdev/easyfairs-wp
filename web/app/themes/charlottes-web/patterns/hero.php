 ...
 */
?>
<!-- wp:cover {"className":"hero-section","dimRatio":70,"overlayColor":"contrast","minHeight":600,"minHeightUnit":"px","isDark":true,"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|xx-large","bottom":"var:preset|spacing|xx-large"}}}} -->
<div class="wp-block-cover alignfull is-dark hero-section" style="min-height:600px;padding-top:var(--wp--preset--spacing--xx-large);padding-bottom:var(--wp--preset--spacing--xx-large)">
  ...
  <div class="wp-block-cover__inner-container">
    ...
    <div class="wp-block-group">
      ...
      <p class="has-text-align-center has-base-color has-text-color has-medium-font-size">Where ideas meet innovation. Join thousands of industry leaders at the most anticipated events of the year.</p>
      <!-- /wp:paragraph -->
